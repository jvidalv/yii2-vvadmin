                    ...
                    <ul class="nav nav-pills">
                        <li class="nav-item small">
                            <div class="nav-link cursor-pointer <?= $activa == 'totals' ? 'active' : null ?>"
                                 onclick="insertParam('NoticiaSearch[borrat]', 0)">Totals (<?= $tamanyActives ?>)
                            </div>
                        </li>
                        <li class="nav-item cursor-pointer small">
                            <div class="nav-link cursor-pointer <?= $activa == 'paperera' ? 'active' : null ?>"
                                 onclick="insertParam('NoticiaSearch[borrat]', 1)">Paperera (<?= $tamanyPapelera ?>)
                            </div>
                        </li>
                    </ul>
                </div>
                <div class="table-data__tool-right">
                    <form>
                        <div class="input-group">
                            ...
                            <input type="text" name="NoticiaSearch[general]" value="<?= $searchModel['general'] ?>"
                                   onblur="insertParam('NoticiaSearch[general]', this.value  )"
