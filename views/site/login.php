                                ...
                                <div class="mt-4">
                                  <div>
                                    <?= $form->field($model, 'email')->textInput(
                                      ...
                                      <label id="error-label-email" class="m-0 float-right small text-danger error-label"></label>
                                  </div>
                                  <div class="d-flex flex-row-reverse flex-wrap w-100 mt-4">
                                    ...
                                    <div style="flex-grow: 1">
                                      <a href="https://www.fempoble.app/contactar" class="text-secondary"><?= Yii::t('app','Vols solicitar un compte?') ?></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                                ...
                                <div class="mt-4">
                                  <div>
                                    <?= $form->field($model, 'password')->passwordInput(
                                      ...
                                      <label id="error-label-password" class="m-0 float-right small text-danger error-label"></label>
                                  </div>
                                  <div class="d-flex flex-row-reverse flex-wrap w-100 mt-4">
                                    <div>
                                      <span id="seguent-password" class="btn btn-primary bg-blau-fosc br cursor-pointer">
                                        <?= Yii::t('app','Següent') ?>
                                      </span>
                                    </div>
                                    <div style="flex-grow: 1">
                                      <a href="mailto:info@fempoble.app" class="text-secondary"><?= Yii::t('app','No recordes la teva contrassenya?') ?></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
